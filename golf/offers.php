	...
	<div id="popup-container">
		...
		<table cellspacing="0" cellpadding="2">
			...
			<tr>
				...
				<td>
					<textarea name="share[message]" rows="4" cols="40"><?=$offerData[0]["one_liner"];?> for just $<?=$offerData[0]["price"];?> at #FindMyMonkey http://www.findmymonkey.com/offer-details?offer_id=<?=$offerData[0]["offer_id"];?></textarea>
				</td>
			</tr>
			<tr>
				<td></td>
				...
				<div style="margin-top: 15px;">
					<button type="submit" name="share[btn]" class="button-special">Share This Deal!</button>
				</div>
				</td>
			</tr>
		</table>
			...
			<?php if(!$notAvailable){ ?>
				...
				<div style="text-align: center; overflow: hidden; margin-top: 12px;">
					...
					<div style="float: left; padding-left: 7px;">
						<a href="http://twitter.com/home?status=<?=urlencode($offerData[0]["one_liner"] . " for just $" . $offerData[0]["price"] . " at #FindMyMonkey http://www.findmymonkey.com/offer-details?offer_id={$offerData[0]["offer_id"]}");?>"><img src="assets/gfx/icons/twitter-ico.png" alt="" title="" border="0"/></a>
						<a href="http://www.facebook.com/sharer.php?u=<?=urlencode($offerData[0]["one_liner"] . " for just $" . $offerData[0]["price"] . " at #FindMyMonkey http://www.findmymonkey.com/offer-details?offer_id={$offerData[0]["offer_id"]}");?>"><img src="assets/gfx/icons/fb-ico.png" alt="" title="" border="0"/></a>
						<a href="javascript:void(0);" onclick="DoSharePopup()"><img src="assets/gfx/icons/email-ico.png" alt="" title="" border="0"/></a>
					</div>
				</div>
			<?php } ?>
			</div>
	...
	<div id="content-container" style="min-height: 400px;">
		...
		<div class="content-sidebar">
			...
			<?php if(!$notAvailable){ ?>
				...
				<p><a href="donate"><img src="assets/gfx/misc/send-money.png" alt="" title="" border="0"/></a></p>
				...
				<p><a href="http://twitter.com/FindMyMonkeyLA" target="_blank"><img src="assets/gfx/misc/follow-twitter.png" border="0" style="margin-left: 30px;" alt="" title=""/></a></p>
			<?php } ?>
			</div>
