...
$Application->CheckForParameters();
$offerData = $Application->GetDetailedOffer();
$locationsAvailable = $Application->GetLocationsAvailableForOffer();
...
<!--Title-->
<title><?php if( !$notAvailable) { echo $offerData[0]["one_liner"]; } else { echo "404: Offer Not Found."; } ?></title>
...
<?php include "assets/header-bot.php"; ?>
	...
	<div id="popup-container">
		...
		<form name="form-data" method="post" action="offer-details">
	...
	<div id="top-content-container">
		...
		<div id="top-content">
			...
			<div class="col-alerts" style="text-align: center;">
				Offer Available @ These Locations:<br/>
				<?php
					foreach( $locationsAvailable as $location )
					{// locations
					?>
					<a style="color: #FFFFFF;" href="offers?location_id=<?=$location["location_id"];?>"><?=$location["location"];?></a><br/>
					<?php
					}
				?>
