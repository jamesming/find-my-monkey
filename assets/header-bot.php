	...
	<div id="header">
		<div style="overflow: hidden;">
			<div style="float: left;">
				<a href="deals"><img src="<?=path;?>assets/gfx/misc/find-my-monkey-logo.png" alt="" title="" border="0" style="position: absolute;"/></a>
			</div>
			<div style="float: left; margin-top: 15px; width: 950px;">
				<div style="margin-left: 145px; overflow: hidden;">
					<!--Find My Monkey Text-->
					<div style="float: left;">
						<a href="deals"><img src="<?=path;?>assets/gfx/misc/find-my-monkey-text.png" alt="" title="" border="0"/></a>
					</div>
					<!--Float Right-->
